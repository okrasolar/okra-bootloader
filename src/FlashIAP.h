...
class FlashIAP : public IFlashStorage
{
  public:
    FlashIAP(System& system);
    virtual ~FlashIAP() = default;

    virtual void copyFlashBlock(uint32_t sourceAddress, uint32_t destinationAddress, int32_t size) override;
